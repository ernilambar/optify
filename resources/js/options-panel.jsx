...
import {
	Panel, PanelBody, PanelRow, TextControl, RadioControl, CheckboxControl, SelectControl, Button, Notice, TextareaControl, ToggleControl, ButtonGroup,
} from '@wordpress/components';

const OptionsPanel = ({
	config, restUrl, nonce, panelId, onSave, onError, underCog = false,
}) => {
	...
	const {
		panelTitle, saveButtonText, savingText, loadingText, messages,
	} = config;
			...
			case 'text':
				...
				return (
					<div className="optify-field optify-field-type-text">
						<label className="optify-field-label">
							{label}
						</label>
						<input
							type="text"
			...
			case 'heading':
				return (
					<div className="optify-field optify-field-type-heading">
						<h3 className="optify-field-heading">
							{label}
						</h3>
					</div>
				);
				...
				if (messageStatus === 'description') {
					return (
						<div className="optify-field optify-field-type-message">
							<div className="optify-field-message">
								{label}
							</div>
						</div>
					);
			...
			<div className="optify-options-panel optify-options-panel--under-cog">
				...
				<div className="optify-cog-container">
					<Button
						...
						aria-label={isCogExpanded ? __('Hide settings', 'optify') : __('Show settings', 'optify')}
					>
						<svg
							width="16"
							height="16"
