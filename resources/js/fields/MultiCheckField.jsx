...
const MultiCheckField = ( { field, value, onChange } ) => {
    ...
    if ( process.env.NODE_ENV === 'development' ) {
        ...
        console.log( `Multi-check field "${ name }" value:`, value, 'processed as:', filteredValue );
    }

    const groupClass = `optify-field-multi-check-group optify-field-multi-check-group--${ settings.layout }${ settings.spacing === 'tight' ? ' optify-field-multi-check-group--tight' : '' }`;
